...
class GovUserManagementScreen extends StatefulWidget {
  ...
  @override
  State<GovUserManagementScreen> createState() =>
      _GovUserManagementScreenState();
}

class _GovUserManagementScreenState extends State<GovUserManagementScreen> {
  final UserService _userService = UserService();
  String _searchQuery = '';
  List<api.User> _users = [];
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    leading: CircleAvatar(
                      ...
                      child: Icon(
                        user.role == 'municipality_admin'
                            ...
                            : Icons.person,
                        color: user.role == 'municipality_admin'
                            ? Colors.orange
                            : AppTheme.deepBlue,
                        size: 20,
                      ),
                    ...
                    trailing: Switch.adaptive(
                      ...
                      onChanged: (val) {}, // Read-only for now
                    ),
                    childrenPadding: const EdgeInsets.fromLTRB(16, 0, 16, 16),
                    children: [
                      const Divider(),
                      _userDetailRow(Icons.phone_outlined, "Phone", user.phone),
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: AppTheme.crimson.withValues(
                                alpha: 0.1,
                              ),
